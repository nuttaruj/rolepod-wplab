...
export const wpAdminOneTimeLinkToolDef = {
  ...
  description:
    ...
    "Security: whoever opens the URL holds a full admin session, and anything recorded during it is at least an internal artifact. A Playwright trace carries the auth cookie outright; a HAR carries it on older uiproof and carries the admin page bodies either way; video shows whatever was on screen. Check an artifact before sharing it rather than assuming it was scrubbed.",
