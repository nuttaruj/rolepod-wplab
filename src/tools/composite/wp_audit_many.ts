...
export async function wpAuditManyHandler(
  ...
  await writeFile(consolidatedPath, JSON.stringify({ run_id: runId, reports }, null, 2), 'utf8')

  return AuditManyOutputSchema.parse({ run_id: runId, reports, consolidated_path: consolidatedPath })
}
