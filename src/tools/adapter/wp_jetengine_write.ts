...
export const wpJetengineWriteToolDef = {
  ...
  description:
    "Write JetEngine post meta on a connected target. v1.8 supports scope=post_meta only — pass { post_id, meta: {key: value, ...} }. Field-group / CCT creation is plugin-internal; use the JetEngine admin UI or wp-cli for those. Auto-ledgered.",
