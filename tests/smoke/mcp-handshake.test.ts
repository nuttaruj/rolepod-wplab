  ...
  it("returns all v0.0 tools from tools/list", async () => {
    await withServer(async (proc, awaitResponse) => {
      ...
      expect(names).toEqual([
        ...
        "rolepod_wp_builder_detect",
        "rolepod_wp_cache_tool",
        "rolepod_wp_cf7_form_create",
        "rolepod_wp_changes_panic",
        "rolepod_wp_changes_query",
        "rolepod_wp_changes_toggle",
        "rolepod_wp_changes_toggle_bulk",
        "rolepod_wp_child_theme_create",
        "rolepod_wp_cli_run",
        "rolepod_wp_clone",
        "rolepod_wp_comment",
        ...
        "rolepod_wp_elementor_html_audit",
        "rolepod_wp_elementor_publish",
        ...
        "rolepod_wp_elementor_validate_data",
        "rolepod_wp_elementor_widget_attribute",
        ...
        "rolepod_wp_maintenance_update",
        "rolepod_wp_media_optimize",
        "rolepod_wp_media_upload",
